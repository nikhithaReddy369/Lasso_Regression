...
This study also embarked on a subgroup analysis, focusing on the impact of racial background on outcomes. This involved conducting separate LASSO regressions for individuals identified as black and non-black, aiming to uncover distinct patterns and the model's predictive accuracy within these demographic charts.
...
Subgroup 2 (Non-Black): For the non-black subgroup, the model showed an improved fit with an MSE of 1.705985 and an R² of 0.3978475	. This result suggests that nearly 40.07% of the variance in the composite score is accounted for, indicating a better predictive accuracy compared to the black subgroup.
